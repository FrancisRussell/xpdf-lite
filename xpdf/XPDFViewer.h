...
private:
  ...
  void cmdRotateCCW(GooString *args[], int nArgs, XEvent *event);
  void cmdRotateCW(GooString *args[], int nArgs, XEvent *event);
  ...
  void cmdSetSelection(GooString *args[], int nArgs, XEvent *event);
  ...
  void cmdZoomFitHeight(GooString *args[], int nArgs, XEvent *event);
