...
void XPDFViewer::cmdRotateCCW(GooString *args[], int nArgs,
			     XEvent *event) {
  int r;
...
void XPDFViewer::cmdRotateCW(GooString *args[], int nArgs,
			     XEvent *event) {
  int r;
...
void XPDFViewer::cmdSetSelection(GooString *args[], int nArgs, XEvent *event) {
